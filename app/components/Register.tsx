        ...
        <div className="w-full max-w-md z-10">
          ...
          <form className="space-y-10" onSubmit={handleSubmit}>
            ...
            {!isLogin && (
              <>
                <div className="relative group">
                  ...
                  />
                  <label htmlFor="name" className="absolute left-0 top-3 text-gray-500 text-sm uppercase tracking-widest pointer-events-none transition-all duration-300 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-gold peer-[:not(:placeholder-shown)]:-translate-y-6 peer-[:not(:placeholder-shown)]:scale-75 peer-autofill:-translate-y-6 peer-autofill:scale-75 peer-autofill:text-gold">
                    Nombre Completo
                  </label>
                </div>
                ...
                <div className="relative group">
                  ...
                  />
                  <label htmlFor="phone" className="absolute left-0 top-3 text-gray-500 text-sm uppercase tracking-widest pointer-events-none transition-all duration-300 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-gold peer-[:not(:placeholder-shown)]:-translate-y-6 peer-[:not(:placeholder-shown)]:scale-75 peer-autofill:-translate-y-6 peer-autofill:scale-75 peer-autofill:text-gold">
                    Teléfono Celular
                  </label>
                </div>
              </>
            ...
            <div className="relative group">
              ...
              />
              <label htmlFor="email" className="absolute left-0 top-3 text-gray-500 text-sm uppercase tracking-widest pointer-events-none transition-all duration-300 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-gold peer-[:not(:placeholder-shown)]:-translate-y-6 peer-[:not(:placeholder-shown)]:scale-75 peer-autofill:-translate-y-6 peer-autofill:scale-75 peer-autofill:text-gold">
                 Correo Electrónico
              </label>
            </div>
            ...
            <div className="relative group">
              ...
              />
              <label htmlFor="password" className="absolute left-0 top-3 text-gray-500 text-sm uppercase tracking-widest pointer-events-none transition-all duration-300 peer-focus:-translate-y-6 peer-focus:scale-75 peer-focus:text-gold peer-[:not(:placeholder-shown)]:-translate-y-6 peer-[:not(:placeholder-shown)]:scale-75 peer-autofill:-translate-y-6 peer-autofill:scale-75 peer-autofill:text-gold">
                Contraseña
              </label>
            </div>
