...
import Hero, { type CarouselImage } from './components/Hero';
...
export default function HomeClient({ initialCarouselImages }: { initialCarouselImages: CarouselImage[] }) {
      ...
      <AnimatePresence mode="wait">
        {view === 'landing' && (
          ...
          >
            ...
            <main>
              <Hero initialImages={initialCarouselImages} onExploreClick={() => document.getElementById('coleccion')?.scrollIntoView({ behavior: 'smooth' })} />
