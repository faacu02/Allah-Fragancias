...
async function uploadImage(file) {
    ...
    const result = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$cloudinary$2f$cloudinary$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["v2"].uploader.upload(base64, {
...
async function POST(request) {
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyAdmin"])(request);
    ...
    try {
        ...
        if (files.length > 0) {
            const uploadPromises = files.filter((f)=>f.size > 0).map((f)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$cloudinary$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uploadImage"])(f));
        ...
        const newProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].product.create({
            data: {
                name: formData.get('name'),
                collection: formData.get('collection'),
                price: parseFloat(formData.get('price')) || 0,
                stock: parseInt(formData.get('stock')) || 0,
                status: parseInt(formData.get('stock')) < 10 ? 'LOW' : 'OK',
                images: images
            }
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__091e9b14._.js.map